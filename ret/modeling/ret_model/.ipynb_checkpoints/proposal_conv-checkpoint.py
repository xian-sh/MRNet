...
def build_proposal_conv(cfg, mask2d,x):
    input_size = x
    hidden_size = cfg.MODEL.RET.PREDICTOR.HIDDEN_SIZE
    kernel_size = cfg.MODEL.RET.PREDICTOR.KERNEL_SIZE
    num_stack_layers = cfg.MODEL.RET.PREDICTOR.NUM_STACK_LAYERS
    output_size = cfg.MODEL.RET.JOINT_SPACE_SIZE
