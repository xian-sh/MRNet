...
from ret.engine.trainer import do_train
...
from ret.utils.miscellaneous import mkdir, save_config
import logging
...
def train(cfg, local_rank, distributed):
    ...
    if cfg.SOLVER.RESUME:
        ...
        path = '%s_model_%de.pth' % (cfg.MODEL.RET.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
...
def main():
    ...
    logger = setup_logger("ret", output_dir, get_rank())
